	...
	return (
		<div
			className={clsx(
				...
				"before:fixed before:top-0 before:bottom-0 before:left-1/2 before:-z-10 before:w-1/2 before:border-l before:border-neutral-200 before:bg-neutral-50 before:content-none before:lg:content-['']",
			)}
		>
