	...
	return (
		...
		>
			<input
				...
				value={value}
				checked={selected}
				className='focus:ring-opacity-50 rounded-full border-neutral-300 text-neutral-600 shadow-sm focus:border-neutral-300 focus:ring focus:ring-neutral-200 focus:ring-offset-0'
			/>
