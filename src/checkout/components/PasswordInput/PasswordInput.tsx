				...
				<label className='text-xs text-neutral-700'>
					...
					<div className='relative mt-1 flex items-stretch shadow-sm'>
						<input
							...
							{...props}
							className={clsx(
								'focus:ring-opacity-50 block w-full appearance-none rounded-md border-neutral-300 pr-10 transition-colors focus:border-neutral-300 focus:ring focus:ring-neutral-200 focus:outline-none active:border-neutral-200 active:outline-none',
						...
						<IconButton
							...
							className='focus:ring-opacity-50 absolute right-0 mt-px flex h-10 w-10 items-center justify-center rounded-md text-center focus:border-neutral-300 focus:ring focus:ring-neutral-200 focus:outline-none active:border-neutral-200 active:outline-none'
						/>
					</div>
				</label>
			</div>
